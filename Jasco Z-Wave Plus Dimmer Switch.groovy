 ...
 *
 *	Author: Bradlee Sutton
 *	Date: 10/04/2018
 *
 *	Changelog:
 *
 *       (10/04/2018) - Add support for additions in firmware 5.29
...
metadata {
	...
	tiles(scale:2) {
        ...
        controlTile("minimumDim", "device.minimumDim", "slider", width: 4, height: 1, range:"(1..99)", inactiveLabel: false) {
			state "default", action:"setMinimumDim"
		}
